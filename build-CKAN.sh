...
create-baseline-ami () {
  ...
  # Amazon Linux 2023 AMI 2023.12.20260831.0 arm64 HVM kernel-6.12 (al2023-ami-2023.12.20260831.0-kernel-6.12-arm64) - 2026-08-26T15:32:49.000Z
  VANILLA_IMAGE_ID="ami-0e3398f29473bb4be"
  read -r \
    LATEST_IMAGE_NAME \
