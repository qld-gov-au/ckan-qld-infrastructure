...
ansible-playbook -i inventory/hosts "Publications-database.yml" --extra-vars "Environment=$bamboo_deploy_environment" -vvv
ansible-playbook -i inventory/hosts "Publications-efs.yml" --extra-vars "Environment=$bamboo_deploy_environment" -vvv
